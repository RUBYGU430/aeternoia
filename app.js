...
const TRANSLATIONS = {
    ko: {
        ...
        instruction_stage_1: "<b>조작 방법:</b> 화면을 클릭하거나 마우스를 드래그하여 에테르노아의 소리를 들어보세요.",
        instruction_mixing: "<b>조작 방법:</b> 화면을 클릭하거나 마우스를 드래그하여 액체를 저어보세요.",
        instruction_stage_2: "<b>조작 방법:</b> 화면을 클릭하거나 드래그하여 숲속의 자연 ASMR 소리를 느껴보세요.",
        instruction_stage_3: "<b>조작 방법:</b> 화면을 클릭하거나 드래그하여 심해 유적의 고요한 소리를 탐험해보세요.",
        instruction_stage_4: "<b>조작 방법:</b> 화면을 클릭하거나 드래그하여 미래 사이버 연구소의 기계음을 제어해보세요.",
        instruction_stage_5: "<b>조작 방법:</b> 화면을 클릭하거나 드래그하여 왕성의 고풍스럽고 우아한 클래식 소리를 감상해보세요.",
        instruction_default: "<b>조작 방법:</b> 화면을 클릭하거나 마우스를 드래그하여 소리를 들어보세요.",
        tab_inventory: "보관함",
        stress_none: "증상 없음",
        ...
        instruction_stage_6: "<b>조작 방법:</b> 화면을 클릭하거나 드래그하여 천상의 성스러운 파동과 멜로디로 영혼을 치유하세요.",
        ...
        tutorial_prev: "◀ 이전",
        tutorial_next: "다음 ▶",
        instruction_room_crystal: "<b>조작 방법:</b> 수정을 가볍게 클릭하거나 드래그하여 영롱한 탭핑 소리를 들어보세요.",
        instruction_room_potion: "<b>조작 방법:</b> 마법 물약병을 클릭하거나 드래그하여 신비로운 액체를 섞어보세요.",
        instruction_room_waterbowl: "<b>조작 방법:</b> 수반을 클릭하거나 꽃잎을 드래그하여 찰랑이는 물소리를 즐겨보세요.",
        instruction_room_sand: "<b>조작 방법:</b> 모래를 클릭하거나 드래그하여 사각사각 잘리는 기분 좋은 소리를 들어보세요.",
        instruction_room_chimes: "<b>조작 방법:</b> 우주 풍경종을 클릭하거나 드래그하여 맑고 은은한 잔향을 퍼뜨려보세요.",
        instruction_room_musicbox: "<b>조작 방법:</b> 오르골을 클릭하거나 태엽을 드래그하여 포근한 멜로디를 감상해보세요.",
        instruction_room_rainwindow: "<b>조작 방법:</b> 창문을 클릭하여 빗방울을 맺히게 하거나, 드래그하여 빗물을 닦아보세요.",
        instruction_room_woodblock: "<b>조작 방법:</b> 나무 블록을 클릭하거나 드래그하여 투박하고 포근한 나무 소리를 들어보세요.",
        instruction_room_leaves: "<b>조작 방법:</b> 나뭇잎을 클릭하거나 드래그하여 바스락거리는 숲속 소리를 만들어보세요.",
        instruction_room_campfire: "<b>조작 방법:</b> 모닥불을 클릭하거나 드래그하여 타닥타닥 타오르는 따뜻한 불꽃 소리를 느껴보세요.",
        instruction_room_singingbowl: "<b>조작 방법:</b> 싱잉보울을 클릭하여 맑게 울리거나, 테두리를 드래그하여 깊은 진동음을 이어가보세요.",
        instruction_room_birdsong: "<b>조작 방법:</b> 숲속을 클릭하거나 드래그하여 상쾌하고 맑은 새소리를 불러보세요.",
        instruction_room_stream: "<b>조작 방법:</b> 계곡물을 클릭하거나 드래그하여 시원하게 흐르는 여울 소리를 들어보세요.",
        instruction_room_crickets: "<b>조작 방법:</b> 풀숲을 클릭하거나 드래그하여 고요한 밤의 풀벌레 소리를 울려보세요.",
        instruction_room_bubbles: "<b>조작 방법:</b> 물속을 클릭하거나 드래그하여 뽀글뽀글 터지는 심해 공기방울을 만들어보세요.",
        instruction_room_submarine: "<b>조작 방법:</b> 잠수함을 클릭하거나 드래그하여 낮게 깔리는 묵직한 수중 진동을 느껴보세요.",
        instruction_room_whale: "<b>조작 방법:</b> 고래를 클릭하거나 물결을 드래그하여 신비로운 고래의 노래를 들어보세요.",
        instruction_room_waterflow: "<b>조작 방법:</b> 바다를 클릭하거나 드래그하여 부드럽게 밀려오는 심해 해류를 만들어보세요.",
        instruction_room_coral: "<b>조작 방법:</b> 산호초를 클릭하거나 마우스로 스쳐 드래그하여 사각거리는 산호 소리를 들어보세요.",
        instruction_room_oxygentank: "<b>조작 방법:</b> 산소통을 클릭하거나 드래그하여 규칙적이고 평온한 잠수 호흡음을 들어보세요.",
        instruction_room_caveecho: "<b>조작 방법:</b> 동굴 벽면을 클릭하거나 드래그하여 깊은 해저 동굴의 울림을 깨워보세요.",
        instruction_room_keyboard: "<b>조작 방법:</b> 키보드를 클릭하거나 드래그하여 도각도각 경쾌한 기계식 타건음을 들어보세요.",
        instruction_room_glitch: "<b>조작 방법:</b> 홀로그램을 클릭하거나 드래그하여 찌릿찌릿한 사이버 글리치 사운드를 제어해보세요.",
        instruction_room_spaceship: "<b>조작 방법:</b> 우주선 콘솔을 클릭하거나 드래그하여 미래형 하이퍼드라이브 엔진 소리를 들어보세요.",
        instruction_room_serverfan: "<b>조작 방법:</b> 서버 팬을 클릭하거나 드래그하여 시원하고 일정한 쿨러 바람 소리를 느껴보세요.",
        instruction_room_servomotor: "<b>조작 방법:</b> 관절을 클릭하거나 드래그하여 정밀한 서보 모터와 기계 구동음을 들어보세요.",
        instruction_room_datatransfer: "<b>조작 방법:</b> 데이터 선로를 클릭하거나 드래그하여 쏟아지는 전자 펄스와 데이터 전송음을 들어보세요.",
        instruction_room_zerogpod: "<b>조작 방법:</b> 캡슐을 클릭하거나 드래그하여 우주 유영 중 들리는 무중력 음향을 느껴보세요.",
        instruction_room_quill: "<b>조작 방법:</b> 깃펜을 클릭하거나 양피지 위로 드래그하여 사각사각 필기 소리를 들어보세요.",
        instruction_room_parchment: "<b>조작 방법:</b> 마법서를 클릭하거나 드래그하여 오래된 고서 페이지 넘기는 소리를 들어보세요.",
        instruction_room_teacup: "<b>조작 방법:</b> 찻잔이나 티스푼을 클릭하거나 드래그하여 우아한 도자기와 은수저 소리를 들어보세요.",
        instruction_room_royalchimes: "<b>조작 방법:</b> 황금 샹들리에를 클릭하거나 드래그하여 웅장한 크리스탈 공명을 느껴보세요.",
        instruction_room_velvet: "<b>조작 방법:</b> 벨벳 커튼을 클릭하거나 드래그하여 묵직하고 포근한 천 스치는 소리를 들어보세요.",
        instruction_room_chess: "<b>조작 방법:</b> 체스 말을 클릭하거나 드래그하여 대리석 판에 부딪히는 경쾌한 달칵 소리를 들어보세요.",
        instruction_room_royalfire: "<b>조작 방법:</b> 왕실 벽난로를 클릭하거나 드래그하여 거대한 장작이 타오르는 소리를 감상해보세요.",
        instruction_room_harp: "<b>조작 방법:</b> 천상의 하프 줄을 클릭하거나 드래그하여 영혼을 정화하는 은은한 선율을 튕겨보세요.",
        instruction_room_clouds: "<b>조작 방법:</b> 푹신한 구름을 클릭하거나 드래그하여 포근하고 부드러운 산책 소리를 들어보세요.",
        instruction_room_halo: "<b>조작 방법:</b> 천사의 광배를 클릭하거나 드래그하여 성스러운 빛의 파동과 백색소음을 느껴보세요.",
    ...
    en: {
        ...
        instruction_stage_1: "<b>Controls:</b> Click or drag the mouse to play the comforting sounds of Aeternoia.",
        instruction_mixing: "<b>Controls:</b> Click or drag to stir and blend the mixture.",
        instruction_stage_2: "<b>Controls:</b> Click or drag to immerse yourself in the soothing forest ASMR sounds.",
        instruction_stage_3: "<b>Controls:</b> Click or drag to explore the deep ocean ruins and tranquil water sounds.",
        instruction_stage_4: "<b>Controls:</b> Click or drag to control the rhythmic cybernetic sounds of the futuristic lab.",
        instruction_stage_5: "<b>Controls:</b> Click or drag to enjoy the antique, elegant sounds of the royal castle.",
        instruction_default: "<b>Controls:</b> Click or drag across the screen to interact.",
        ...
        instruction_stage_6: "<b>Controls:</b> Click or drag to cleanse the soul with sacred celestial waves and melodies.",
        ...
        tutorial_prev: "◀ Prev",
        tutorial_next: "Next ▶",
        instruction_room_crystal: "<b>Controls:</b> Click or drag the crystal to hear pure, crystalline tapping sounds.",
        instruction_room_potion: "<b>Controls:</b> Click or drag the potion flask to mix and swirl magical elixirs.",
        instruction_room_waterbowl: "<b>Controls:</b> Click or drag petals across the water bowl to create gentle rippling sounds.",
        instruction_room_sand: "<b>Controls:</b> Click or drag to slice kinetic sand with crunchy, satisfying cuts.",
        instruction_room_chimes: "<b>Controls:</b> Click or drag the cosmic wind chimes to spread gentle, resonant reverberations.",
        instruction_room_musicbox: "<b>Controls:</b> Click or drag to wind the music box and play a soothing, continuous melody.",
        instruction_room_rainwindow: "<b>Controls:</b> Click to drop raindrops on the window, or drag to wipe away the water.",
        instruction_room_woodblock: "<b>Controls:</b> Click or drag the wood block to hear warm, rustic wooden clacks.",
        instruction_room_leaves: "<b>Controls:</b> Click or drag to scatter dry leaves and produce crisp, rustling sounds.",
        instruction_room_campfire: "<b>Controls:</b> Click or drag the campfire to stir embers and hear cozy, crackling flames.",
        instruction_room_singingbowl: "<b>Controls:</b> Click the singing bowl for a clear chime, or drag along the rim for deep resonant hums.",
        instruction_room_birdsong: "<b>Controls:</b> Click or drag across the canopy to beckon fresh, chirping birdsongs.",
        instruction_room_stream: "<b>Controls:</b> Click or drag along the stream to hear refreshing, rushing mountain waters.",
        instruction_room_crickets: "<b>Controls:</b> Click or drag through the bushes to awaken peaceful night crickets.",
        instruction_room_bubbles: "<b>Controls:</b> Click or drag through the deep water to release playful, popping bubbles.",
        instruction_room_submarine: "<b>Controls:</b> Click or drag the submarine to trigger deep, low-frequency engine hums.",
        instruction_room_whale: "<b>Controls:</b> Click or drag the gentle whale to awaken mystical, far-reaching whale songs.",
        instruction_room_waterflow: "<b>Controls:</b> Click or drag across the water to guide sweeping, gentle ocean currents.",
        instruction_room_coral: "<b>Controls:</b> Click or brush-drag along the coral reef for delicate, brittle scraping textures.",
        instruction_room_oxygentank: "<b>Controls:</b> Click or drag the scuba regulator to trigger steady, meditative breathing rhythms.",
        instruction_room_caveecho: "<b>Controls:</b> Click or drag around the cavern to evoke echoing subterranean droplets.",
        instruction_room_keyboard: "<b>Controls:</b> Click or drag across the keys to trigger crisp, rhythmic mechanical keyboard thuds.",
        instruction_room_glitch: "<b>Controls:</b> Click or drag the hologram to trigger futuristic digital glitches and static.",
        instruction_room_spaceship: "<b>Controls:</b> Click or drag the cockpit panel to activate cosmic warp drive engine hums.",
        instruction_room_serverfan: "<b>Controls:</b> Click or drag the server cooler to produce steady, soothing cooling fans.",
        instruction_room_servomotor: "<b>Controls:</b> Click or drag robotic joints to hear smooth, high-precision servo motor whirs.",
        instruction_room_datatransfer: "<b>Controls:</b> Click or drag along data pathways to stream rhythmic pulses of cybernetic data.",
        instruction_room_zerogpod: "<b>Controls:</b> Click or drag inside the Zero-G pod to float amid soothing anti-gravity ambiances.",
        instruction_room_quill: "<b>Controls:</b> Click or drag the quill pen across the parchment to hear satisfying writing scratches.",
        instruction_room_parchment: "<b>Controls:</b> Click or drag ancient spellbook pages to hear dry, papery book rustles.",
        instruction_room_teacup: "<b>Controls:</b> Click or drag the teacup and spoon to produce delicate porcelain clinks.",
        instruction_room_royalchimes: "<b>Controls:</b> Click or drag the golden chandelier to sway sparkling crystals with rich resonances.",
        instruction_room_velvet: "<b>Controls:</b> Click or drag across the velvet curtain for a soft, heavy, muffled fabric rustle.",
        instruction_room_chess: "<b>Controls:</b> Click or drag polished marble chess pieces to hear crisp, tactile clacks.",
        instruction_room_royalfire: "<b>Controls:</b> Click or drag the royal hearth to stir massive oak logs with deep crackling warmth.",
        instruction_room_harp: "<b>Controls:</b> Click or strum-drag across the celestial harp strings to weave soul-cleansing melodies.",
        instruction_room_clouds: "<b>Controls:</b> Click or drag across the fluffy clouds to step upon ultra-soft, pillowy mists.",
        instruction_room_halo: "<b>Controls:</b> Click or drag the angel's halo to emit holy auroral waves and pure white noise.",
    ...
    ja: {
        ...
        instruction_stage_1: "<b>操作方法:</b> クリックまたはマウスをドラッグして、心地よい音を演奏してみましょう。",
        instruction_mixing: "<b>操作方法:</b> クリックまたはドラッグして、液体をかき混ぜてみましょう。",
        instruction_stage_2: "<b>操作方法:</b> クリックまたはドラッグして、森の自然なASMRサウンドを楽しみましょう。",
        instruction_stage_3: "<b>操作方法:</b> クリックまたはドラッグして、深海遺跡の静かな水音を探索しましょう。",
        instruction_stage_4: "<b>操作方法:</b> クリックまたはドラッグして、未来のサイバー研究所の機械音を制御しましょう。",
        instruction_stage_5: "<b>操作方法:</b> クリックまたはドラッグして、王城の古風で優雅なクラシックサウンドを堪能しましょう。",
        instruction_default: "<b>操作方法:</b> 画面をクリックまたはマウスをドラッグしてインタラクションしてみてください。",
        tab_inventory: "保管庫",
        stress_none: "症状なし",
        ...
        instruction_stage_6: "<b>操作方法:</b> クリックまたはドラッグして、天上の聖なる波動とメロディーで魂を癒やしましょう。",
        ...
        tutorial_prev: "◀ 前へ",
        tutorial_next: "次へ ▶",
        instruction_room_crystal: "<b>操作方法:</b> 水晶を軽くクリックまたはドラッグして、澄んだタッピング音を響かせましょう。",
        instruction_room_potion: "<b>操作方法:</b> 魔法の薬瓶をクリックまたはドラッグして、神秘的な液体を調合しましょう。",
        instruction_room_waterbowl: "<b>操作方法:</b> 水盤をクリックまたは花びらをドラッグして、心地よい水音を響かせましょう。",
        instruction_room_sand: "<b>操作方法:</b> 砂をクリックまたはドラッグして、サクサクと切れる快音を楽しみましょう。",
        instruction_room_chimes: "<b>操作方法:</b> 宇宙の風鈴をクリックまたはドラッグして、清らかな余韻を響かせましょう。",
        instruction_room_musicbox: "<b>操作方法:</b> オルゴールをクリックまたはドラッグして、心温まるメロディーを奏でましょう。",
        instruction_room_rainwindow: "<b>操作方法:</b> 窓をクリックして雨粒を弾ませるか、ドラッグして水滴をぬぐいましょう。",
        instruction_room_woodblock: "<b>操作方法:</b> 木のブロックをクリックまたはドラッグして、温もりある木肌の音を楽しみましょう。",
        instruction_room_leaves: "<b>操作方法:</b> 木の葉をクリックまたはドラッグして、カサカサと心地よい枯れ葉の音を立てましょう。",
        instruction_room_campfire: "<b>操作方法:</b> たき火をクリックまたはドラッグして、パチパチと薪がはぜる温かい音を聴きましょう。",
        instruction_room_singingbowl: "<b>操作方法:</b> シンギングボウルをクリックして清らかに鳴らすか、縁をドラッグして深い共鳴音を響かせましょう。",
        instruction_room_birdsong: "<b>操作方法:</b> 森をクリックまたはドラッグして、爽やかで清らかな小鳥のさえずりを呼び寄せましょう。",
        instruction_room_stream: "<b>操作方法:</b> 渓流をクリックまたはドラッグして、爽快に流れるせせらぎの音を楽しみましょう。",
        instruction_room_crickets: "<b>操作方法:</b> 草むらをクリックまたはドラッグして、穏やかな夜の虫の声に耳を傾けましょう。",
        instruction_room_bubbles: "<b>操作方法:</b> 水中をクリックまたはドラッグして、プチプチ弾ける深海の水泡を放ちましょう。",
        instruction_room_submarine: "<b>操作方法:</b> 潜水艦をクリックまたはドラッグして、重低音で響く静かな水中振動を感じましょう。",
        instruction_room_whale: "<b>操作方法:</b> クジラをクリックまたは波をドラッグして、神秘的なクジラの歌声を響かせましょう。",
        instruction_room_waterflow: "<b>操作方法:</b> 海面をクリックまたはドラッグして、ゆったりと流れる深海潮流を起こしましょう。",
        instruction_room_coral: "<b>操作方法:</b> 珊瑚礁をクリックまたはドラッグで撫でて、繊細な擦れ音を奏でましょう。",
        instruction_room_oxygentank: "<b>操作方法:</b> 酸素ボンベをクリックまたはドラッグして、落ち着いた規則的な深呼吸を聴きましょう。",
        instruction_room_caveecho: "<b>操作方法:</b> 洞窟の壁面をクリックまたはドラッグして、奥深く響き渡る海底洞窟の反響音を呼び覚ましましょう。",
        instruction_room_keyboard: "<b>操作方法:</b> キーボードをクリックまたはドラッグして、スコスコと心地よい打鍵音を奏でましょう。",
        instruction_room_glitch: "<b>操作方法:</b> ホログラムをクリックまたはドラッグして、サイバー感あふれるグリッチ音を制御しましょう。",
        instruction_room_spaceship: "<b>操作方法:</b> 宇宙船のコンソールをクリックまたはドラッグして、ワープエンジンの唸りを響かせましょう。",
        instruction_room_serverfan: "<b>操作方法:</b> 冷却ファンをクリックまたはドラッグして、一定で心地よいファンの白雑音を聴きましょう。",
        instruction_room_servomotor: "<b>操作方法:</b> ロボット関節をクリックまたはドラッグして、精密なサーボモーターの回転音を響かせましょう。",
        instruction_room_datatransfer: "<b>操作方法:</b> データ回線をクリックまたはドラッグして、流れる電子パルスと通信音を感じましょう。",
        instruction_room_zerogpod: "<b>操作方法:</b> 無重力カプセルをクリックまたはドラッグして、浮遊感あふれる静寂の響きを楽しみましょう。",
        instruction_room_quill: "<b>操作方法:</b> 羽ペンをクリックまたは羊皮紙の上へドラッグして、サラサラと心地よい筆記音を奏でましょう。",
        instruction_room_parchment: "<b>操作方法:</b> 魔法書をクリックまたはドラッグして、古書の乾いたページをめくる音を楽しみましょう。",
        instruction_room_teacup: "<b>操作方法:</b> ティーカップやスプーンをクリックまたはドラッグして、優雅な磁器の澄んだ音を響かせましょう。",
        instruction_room_royalchimes: "<b>操作方法:</b> 黄金のシャンデリアをクリックまたはドラッグして、気品あふれる水晶の響きを広げましょう。",
        instruction_room_velvet: "<b>操作方法:</b> ベルベットのカーテンをクリックまたはドラッグして、ふんわり重厚な布の摩擦音を聴きましょう。",
        instruction_room_chess: "<b>操作方法:</b> チェス駒をクリックまたはドラッグして、大理石に響くカチッとした澄んだ音を楽しみましょう。",
        instruction_room_royalfire: "<b>操作方法:</b> 王室の暖炉をクリックまたはドラッグして、太い薪がじっくり燃える贅沢なパチパチ音を聴きましょう。",
        instruction_room_harp: "<b>操作方法:</b> 天上のハープの弦をクリックまたは撫でるようにドラッグして、魂を浄化する清らかな旋律を奏でましょう。",
        instruction_room_clouds: "<b>操作方法:</b> ふわふわの雲をクリックまたはドラッグして、柔らかく心地よい雲の散歩音を聴きましょう。",
        instruction_room_halo: "<b>操作方法:</b> 天使の光輪をクリックまたはドラッグして、聖なる光の波動と清らかなホワイトノイズを感じましょう。",
    ...
    zh: {
        ...
        instruction_stage_1: "<b>操作方法：</b> 点击或拖拽鼠标，随心聆听治愈之声。",
        instruction_mixing: "<b>操作方法：</b> 点击或按住拖拽以搅拌调和。",
        instruction_stage_2: "<b>操作方法：</b> 点击或拖拽，沉浸在森林自然的解压ASMR声中。",
        instruction_stage_3: "<b>操作方法：</b> 点击或拖拽，探索深海遗迹的宁静水声。",
        instruction_stage_4: "<b>操作方法：</b> 点击或拖拽，掌控未来赛博实验室的律动机音。",
        instruction_stage_5: "<b>操作方法：</b> 点击或拖拽，品味王城典雅古朴的贵族质感声。",
        instruction_default: "<b>操作方法：</b> 点击或拖拽画面以进行交互体验。",
        tab_inventory: "储物库",
        stress_none: "无特殊症状",
        stress_normal: "日常压力",
        ...
        instruction_stage_6: "<b>操作方法：</b> 点击或拖拽，以天界神圣光波与旋律治愈洗涤心灵。",
        ...
        tutorial_prev: "◀ 上一步",
        tutorial_next: "下一步 ▶",
        instruction_room_crystal: "<b>操作方法：</b> 轻点或拖拽水晶，聆听清脆剔透的敲击声。",
        instruction_room_potion: "<b>操作方法：</b> 点击或拖拽魔法药水瓶，摇晃调制神秘灵药。",
        instruction_room_waterbowl: "<b>操作方法：</b> 点击水盆或拖动花瓣，激起轻柔清澈的水波声。",
        instruction_room_sand: "<b>操作方法：</b> 点击或拖拽动力沙，享受沙沙切开的解压脆响。",
        instruction_room_chimes: "<b>操作方法：</b> 点击或拖拽宇宙风铃，荡漾悠长空灵的微风回响。",
        instruction_room_musicbox: "<b>操作方法：</b> 点击或拖拽发条八音盒，连绵奏响舒缓治愈的八音盒旋律。",
        instruction_room_rainwindow: "<b>操作方法：</b> 点击在玻璃窗上激起雨滴，或拖动擦拭水汽。",
        instruction_room_woodblock: "<b>操作方法：</b> 点击或拖拽木块，感受朴实厚重的沉稳敲击声。",
        instruction_room_leaves: "<b>操作方法：</b> 点击或拖拽枯叶，激起林间散步般清爽的沙沙声。",
        instruction_room_campfire: "<b>操作方法：</b> 点击或拖拽营火，聆听炭火噼啪作响的温暖柴火声。",
        instruction_room_singingbowl: "<b>操作方法：</b> 点击颂钵发出清亮钟鸣，或沿碗沿拖拽维持深沉平稳的共振余音。",
        instruction_room_birdsong: "<b>操作方法：</b> 点击或拖拽林梢，唤来清脆婉转的林间鸟鸣。",
        instruction_room_stream: "<b>操作方法：</b> 点击或顺水拖拽溪流，聆听清澈奔涌的流水声。",
        instruction_room_crickets: "<b>操作方法：</b> 点击或拂过草丛，唤醒寂静深夜里的幽幽虫鸣。",
        instruction_room_bubbles: "<b>操作方法：</b> 点击或拖拽水流，释放咕噜噜破裂的深海水泡。",
        instruction_room_submarine: "<b>操作方法：</b> 点击或拖拽潜艇，感受低沉厚重的海底巡航震动。",
        instruction_room_whale: "<b>操作方法：</b> 点击鲸鱼或掠过波浪，唤起空灵悠远的深海鲸歌。",
        instruction_room_waterflow: "<b>操作方法：</b> 点击或拖拽海水，掀动平缓起伏的深海暖流。",
        instruction_room_coral: "<b>操作方法：</b> 点击或轻拂掠过珊瑚丛，聆听清爽细腻的珊瑚摩擦音。",
        instruction_room_oxygentank: "<b>操作方法：</b> 点击或拖拽氧气罐，跟随平稳规律的潜水呼吸声沉静身心。",
        instruction_room_caveecho: "<b>操作方法：</b> 点击或掠过溶洞石壁，唤醒海底洞穴深处幽微的回声滴答。",
        instruction_room_keyboard: "<b>操作方法：</b> 点击或滑过键盘按键，敲响利落清脆的机械键盘敲击音。",
        instruction_room_glitch: "<b>操作方法：</b> 点击或划过全息投影，调制富有未来科技感的故障杂讯音。",
        instruction_room_spaceship: "<b>操作方法：</b> 点击或拖拽飞船控制台，启动深沉平缓的曲速引擎轰鸣。",
        instruction_room_serverfan: "<b>操作方法：</b> 点击或拖拽服务器散热扇，感受平稳均匀的清凉气流白噪音。",
        instruction_room_servomotor: "<b>操作方法：</b> 点击或拖拽机械关节，转动顺滑精密的伺服电机运转音。",
        instruction_room_datatransfer: "<b>操作方法：</b> 点击或拖动数据光路，传输流光溢彩的数字脉冲讯号音。",
        instruction_room_zerogpod: "<b>操作方法：</b> 点击或拖拽无重力舱，漫步在轻盈悬浮的失重空灵声场中。",
        instruction_room_quill: "<b>操作方法：</b> 点击或拖拽羽毛笔划过羊皮纸，聆听沙沙流淌的典雅书写声。",
        instruction_room_parchment: "<b>操作方法：</b> 点击或翻动古籍，品味翻阅泛黄魔法书页的清脆纸声。",
        instruction_room_teacup: "<b>操作方法：</b> 点击或轻碰茶杯与银匙，敲出高雅清越的瓷器轻碰脆响。",
        instruction_room_royalchimes: "<b>操作方法：</b> 点击或摇晃黄金水晶吊灯，激荡宏大瑰丽的水晶共鸣音。",
        instruction_room_velvet: "<b>操作方法：</b> 点击或拂动丝绒窗帘，静听厚重柔软织物轻抚的沉静声。",
        instruction_room_chess: "<b>操作方法：</b> 点击或下棋拖拽棋子，叩响大理石棋盘上清亮利落的落子声。",
        instruction_room_royalfire: "<b>操作方法：</b> 点击或拨动王室壁炉，感受粗大橡木薪柴燃烧时深沉丰富的暖心炭火声。",
        instruction_room_harp: "<b>操作方法：</b> 点击或轻拨天界竖琴琴弦，弹奏洗涤灵魂的空灵旋律。",
        instruction_room_clouds: "<b>操作方法：</b> 点击或滑过蓬松云朵，漫步在轻柔如棉的云海之中。",
        instruction_room_halo: "<b>操作方法：</b> 点击或抚掠天使光环，激发神圣光芒律动的空灵白噪音。",
    ...
    fr: {
        ...
        instruction_stage_1: "<b>Commandes :</b> Cliquez ou glissez avec la souris pour écouter les sons apaisants d'Aeternoia.",
        instruction_mixing: "<b>Commandes :</b> Cliquez ou glissez pour mélanger la potion.",
        instruction_stage_2: "<b>Commandes :</b> Cliquez ou glissez pour vous immerger dans les sons ASMR de la forêt.",
        instruction_stage_3: "<b>Commandes :</b> Cliquez ou glissez pour explorer les ruines sous-marines et leurs doux sons d'eau.",
        instruction_stage_4: "<b>Commandes :</b> Cliquez ou glissez pour contrôler les sons mécaniques du laboratoire cybernétique.",
        instruction_stage_5: "<b>Commandes :</b> Cliquez ou glissez pour savourer les sons anciens et nobles du château royal.",
        instruction_default: "<b>Commandes :</b> Cliquez ou glissez sur l'écran pour interagir.",
        ...
        instruction_stage_6: "<b>Commandes :</b> Cliquez ou glissez pour apaiser l'âme avec les ondes et mélodies célestes sacrées.",
        ...
        instruction_room_crystal: "<b>Commandes :</b> Cliquez ou glissez sur le cristal pour entendre de purs tapotements cristallins.",
        instruction_room_potion: "<b>Commandes :</b> Cliquez ou glissez sur la fiole pour mélanger les élixirs magiques.",
        instruction_room_waterbowl: "<b>Commandes :</b> Cliquez ou glissez sur les pétales dans la coupelle pour créer de doux clapotis.",
        instruction_room_sand: "<b>Commandes :</b> Cliquez ou glissez pour découper le sable cinétique avec un crissement relaxant.",
        instruction_room_chimes: "<b>Commandes :</b> Cliquez ou glissez sur les carillons cosmiques pour libérer de douces résonances.",
        instruction_room_musicbox: "<b>Commandes :</b> Cliquez ou glissez pour remonter la boîte à musique et savourer sa douce mélodie.",
        instruction_room_rainwindow: "<b>Commandes :</b> Cliquez pour faire tomber des gouttes de pluie, ou glissez pour essuyer la vitre.",
        instruction_room_woodblock: "<b>Commandes :</b> Cliquez ou glissez sur le bloc de bois pour entendre des sons boisés et chaleureux.",
        instruction_room_leaves: "<b>Commandes :</b> Cliquez ou glissez pour éparpiller les feuilles mortes et créer de doux froissements.",
        instruction_room_campfire: "<b>Commandes :</b> Cliquez ou glissez sur le feu de camp pour raviver les braises et crépitements.",
        instruction_room_singingbowl: "<b>Commandes :</b> Cliquez pour faire tinter le bol chantant, ou glissez sur le bord pour de profondes vibrations.",
        instruction_room_birdsong: "<b>Commandes :</b> Cliquez ou glissez à travers la canopée pour inviter de joyeux chants d'oiseaux.",
        instruction_room_stream: "<b>Commandes :</b> Cliquez ou glissez le long du ruisseau pour écouter le murmure rafraîchissant de l'eau.",
        instruction_room_crickets: "<b>Commandes :</b> Cliquez ou glissez dans les herbes pour éveiller le chant apaisant des grillons nocturnes.",
        instruction_room_bubbles: "<b>Commandes :</b> Cliquez ou glissez dans l'eau pour faire éclater de douces bulles marines.",
        instruction_room_submarine: "<b>Commandes :</b> Cliquez ou glissez sur le sous-marin pour ressentir son vrombissement sourd et apaisant.",
        instruction_room_whale: "<b>Commandes :</b> Cliquez ou glissez sur la baleine pour écouter ses chants mystiques et majestueux.",
        instruction_room_waterflow: "<b>Commandes :</b> Cliquez ou glissez pour susciter de doux et profonds courants océaniques.",
        instruction_room_coral: "<b>Commandes :</b> Cliquez ou glissez sur le corail pour entendre un froissement doux et texturé.",
        instruction_room_oxygentank: "<b>Commandes :</b> Cliquez ou glissez sur la bouteille d'oxygène pour écouter un rythme respiratoire méditatif.",
        instruction_room_caveecho: "<b>Commandes :</b> Cliquez ou glissez sur les parois de la grotte pour éveiller de profonds échos sous-marins.",
        instruction_room_keyboard: "<b>Commandes :</b> Cliquez ou glissez sur les touches pour entendre le cliquetis satisfaisant d'un clavier mécanique.",
        instruction_room_glitch: "<b>Commandes :</b> Cliquez ou glissez sur l'hologramme pour déclencher des glitches numériques futuristes.",
        instruction_room_spaceship: "<b>Commandes :</b> Cliquez ou glissez sur la console spatiale pour écouter le vrombissement d'hyperpropulsion.",
        instruction_room_serverfan: "<b>Commandes :</b> Cliquez ou glissez sur le ventilateur pour entendre un souffle régulier et rafraîchissant.",
        instruction_room_servomotor: "<b>Commandes :</b> Cliquez ou glissez sur les articulations robotiques pour écouter les servomoteurs de précision.",
        instruction_room_datatransfer: "<b>Commandes :</b> Cliquez ou glissez le long des câbles pour envoyer des impulsions de données numériques.",
        instruction_room_zerogpod: "<b>Commandes :</b> Cliquez ou glissez dans la capsule zéro gravité pour planer dans une ambiance flottante.",
        instruction_room_quill: "<b>Commandes :</b> Cliquez ou glissez la plume sur le parchemin pour entendre de doux crissements d'écriture.",
        instruction_room_parchment: "<b>Commandes :</b> Cliquez ou glissez pour tourner les pages du grimoire avec un froissement de vieux papier.",
        instruction_room_teacup: "<b>Commandes :</b> Cliquez ou glissez sur la tasse et la cuillère pour créer de fins tintements de porcelaine.",
        instruction_room_royalchimes: "<b>Commandes :</b> Cliquez ou glissez sur le lustre doré pour faire osciller les cristaux en une noble résonance.",
        instruction_room_velvet: "<b>Commandes :</b> Cliquez ou glissez sur les rideaux de velours pour un froissement feutré et apaisant.",
        instruction_room_chess: "<b>Commandes :</b> Cliquez ou glissez les pièces d'échecs en marbre pour entendre un claquement net et précis.",
        instruction_room_royalfire: "<b>Commandes :</b> Cliquez ou glissez sur la cheminée royale pour attiser les bûches et leur douce chaleur crépitante.",
        instruction_room_harp: "<b>Commandes :</b> Cliquez ou glissez pour pincer les cordes de la harpe céleste et libérer des mélodies sacrées.",
        instruction_room_clouds: "<b>Commandes :</b> Cliquez ou glissez sur les nuages cotonneux pour savourer la douceur d'une marche céleste.",
        instruction_room_halo: "<b>Commandes :</b> Cliquez ou glissez sur l'auréole de l'ange pour diffuser des ondes sacrées et un pur bruit blanc.",
...
function getToolInstruction(roomId) {
    if (!roomId) return t('instruction_default');
    const roomKey = 'instruction_room_' + roomId;
    if (t(roomKey) !== roomKey) {
        return t(roomKey);
    }
    const room = ROOMS.find(r => r.id === roomId);
    if (!room) return t('instruction_default');
    if (roomId === 'potion' || roomId === 'waterbowl') return t('instruction_mixing');
    const stageKey = 'instruction_stage_' + room.stage;
    if (t(stageKey) !== stageKey) {
        return t(stageKey);
    }
